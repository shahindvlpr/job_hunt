                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul class="drop">
                                ...
                                <li><a href="../Development/index.php">Development</a></li>

                                <li><a href="../Engineering/index.php">Engineering</a></li>

                                <li><a href="../Programmer/index.php">Programmer</a></li>

                                <li><a href="../Security/index.php">Security</a></li>

                                <li><a href="../System_Analyst/index.php">System Analyst</a></li>

                                <li><a href="../Data_Science/index.php">Data Science</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
        ...
        <div class="container">
            <div class="right_side-bar">
                <div class="applied_job">
                    <div class="heading">
                        <h1>Administrator Posted Job</h1>
                    </div>
                    <table id="customers">
                        <tr>
                            <th>position</th>
                        ...
                        <?php
                            $query = "SELECT * FROM `job_post` WHERE category='Administrator';";
