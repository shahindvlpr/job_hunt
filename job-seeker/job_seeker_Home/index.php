<?php
    ...
    /**************  Administrator **************/
    $query1 = "SELECT * FROM `job_post` WHERE category = 'Administrator' ;";
    $create_query1 = mysqli_query($conn,$query1);
    $result1 = mysqli_fetch_array($create_query1);
    $Administrator = mysqli_num_rows($create_query1);

    /**************  Data Science **************/
    $query2 = "SELECT * FROM `job_post` WHERE category = 'Data Science' ;";
    $create_query2 = mysqli_query($conn,$query2);
    $result2 = mysqli_fetch_array($create_query2);
    $Data_Science = mysqli_num_rows($create_query2);

    /**************  Design **************/
    $query3 = "SELECT * FROM `job_post` WHERE category = 'Design' ;";
    $create_query3 = mysqli_query($conn,$query3);
    $result3 = mysqli_fetch_array($create_query3);
    $Design = mysqli_num_rows($create_query3);

    /**************  Development **************/
    $query4 = "SELECT * FROM `job_post` WHERE category = 'Development' ;";
    $create_query4 = mysqli_query($conn,$query4);
    $result4 = mysqli_fetch_array($create_query4);
    $Development = mysqli_num_rows($create_query4);

    /**************  Engineering **************/
    $query5 = "SELECT * FROM `job_post` WHERE category = 'Engineering' ;";
    $create_query5 = mysqli_query($conn,$query5);
    $result5 = mysqli_fetch_array($create_query5);
    $Engineering = mysqli_num_rows($create_query5);

    /**************  Programmer **************/
    $query6 = "SELECT * FROM `job_post` WHERE category = 'Programmer' ;";
    $create_query6 = mysqli_query($conn,$query6);
    $result6 = mysqli_fetch_array($create_query6);
    $Programmer = mysqli_num_rows($create_query6);

    /**************  Security **************/
    $query7 = "SELECT * FROM `job_post` WHERE category = 'Security' ;";
    $create_query7 = mysqli_query($conn,$query7);
    $result7 = mysqli_fetch_array($create_query7);
    $Security = mysqli_num_rows($create_query7);

    /**************  System_Analyst **************/
    $query8 = "SELECT * FROM `job_post` WHERE category = 'System Analyst' ;";
    $create_query8 = mysqli_query($conn,$query8);
    $result8 = mysqli_fetch_array($create_query8);
    $System_Analyst = mysqli_num_rows($create_query8);
?>
...
<body>
    <header class="header">
        ...
        <nav class="nav-container nav-container--pall flex flex-jc-sb flex-ai-c">
            ...
            <div class="header__links hide-for-mobile">
                <a href="#">Home</a>
                <a href="#">Blog</a>
                <a href="./seeker_profile/index.php">Profile</a>
                <a href="./contact/index.php">Contact</a>
                <a href="../job_seeker_logout/logoutprocess.php">Log Out</a>
                <button class="button">APPLY A JOB</button>
            </div>
        </nav>
    ...
    <section class="hero container">
        <div class="hero__text">
            ...
            <div class="hero__text-button">
                <button class="button btn-1">SEE OUR JOBS</button>
                <a href="./job_search/index.php"><button class="button btn-2">SEARCH JOBS</button></a>
            </div>        
        </div>
    ...
    <section class="categories container">
        ...
        <div class="categories__content">
            <div class="item">
                <a href="./seeker_job_category/Administrator/index.php" style="color:black;">
                    <i class="fas fa-house-damage icon icon-1"></i>
                </a>
                <div class="item__text">
                    <h4>Administrator</h4>
                    <p>(<?php echo $Administrator;?> jobs)</p>
                </div>              
            </div>
            <div class="item">
                <a href="./seeker_job_category/Data_Science/index.php" style="color:black;">
                    <i class="fas fa-globe icon icon-2"></i>
                </a>               
                <div class="item__text">
                    <h4>Data Science</h4>
                    <p>(<?php echo $Data_Science;?> jobs)</p>
                </div>
            </div>
            <div class="item">
                <a href="./seeker_job_category/Design/index.php" style="color:black;">
                    <i class="fas fa-book icon icon-3"></i>
                </a>               
                <div class="item__text">
                    <h4>Design</h4>
                    <p>(<?php echo $Design;?> jobs)</p>
                </div>
            </div>
            <div class="item">
                <a href="./seeker_job_category/Development/index.php" style="color:black;">
                    <i class="fas fa-desktop icon icon-4"></i>
                </a>              
                <div class="item__text">
                    <h4>Development</h4>
                    <p>(<?php echo $Development;?> jobs)</p>
                </div>
            </div>
            <div class="item">
                <a href="./seeker_job_category/Engineering/index.php" style="color:black;">
                    <i class="fas fa-brush icon icon-5"></i>
                </a>                 
                <div class="item__text">
                    <h4>Engineering</h4>
                    <p>(<?php echo $Engineering;?> jobs)</p>
                </div>
            </div>
            <div class="item">
                <a href="./seeker_job_category/Programmer/index.php" style="color:black;">
                    <i class="far fa-heart icon icon-6"></i>
                </a>               
                <div class="item__text">
                    <h4>Programmer</h4>
                    <p>(<?php echo $Programmer;?> jobs)</p>
                </div>
            </div>
            <div class="item">
                <a href="./seeker_job_category/Security/index.php" style="color:black;">
                    <i class="fas fa-filter icon icon-7"></i>
                </a>                
                <div class="item__text">
                    <h4>Security</h4>
                    <p>(<?php echo $Security;?> jobs)</p>
                </div>
            </div>
            <div class="item">
                <a href="./seeker_job_category/System_Analyst/index.php" style="color:black;">
                    <i class="fas fa-trophy icon icon-8"></i>
                </a>                
                <div class="item__text">
                    <h4>System Analyst</h4>
                    <p>(<?php echo $System_Analyst;?> jobs)</p>
                </div>
            </div>
        </div>
    </section>
